...
public class LivrosLista extends JFrame {
    ...
    public LivrosLista() {
        ...
        // Sort the list alphabetically by the book title
        Collections.sort(livros, new Comparator<LivroModelo>() {
            @Override
            public int compare(LivroModelo o1, LivroModelo o2) {
                return o1.getTitulo().compareToIgnoreCase(o2.getTitulo());
            }
        });

        // Populate the DefaultListModel with the sorted list
        ...
        listaLivros.setFont(new Font("Tahoma", Font.PLAIN, 18));
        ...
        btnVisualizarLivro.setFont(new Font("Tahoma", Font.BOLD, 15));
