...
public class ControleAcervo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ControleAcervo frameControleAcervo = new ControleAcervo();
					frameControleAcervo.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public ControleAcervo() {
		...
		JLabel lblTitutlo = new JLabel("CONTROLE DE ACERVO");
		...
		final JList<LivroModelo> listaLivros = new JList<>(modeloJlist);
