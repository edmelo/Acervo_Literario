...
public class AplicacaoEmail {
    ...
    private String meuEmail = "seuemail@gmail.com";
    private String minhaSenha = "suasenha";
    ...
    public void enviarEmailCadastro(LeitorModelo leitor) throws ExcecaoControlador {
        ...
        email.setStartTLSEnabled(true); // Habilitar TLS

        try {
            email.setFrom(meuEmail);
            email.setSubject("Bem Vindo a Minha Biblioteca Pessoal");
            email.setMsg("Olá " + leitor.getNome() + "\n"
                    + "\nPosso te emprestar até dois livros por vez. \n"
                    + "\nAproveite!");
