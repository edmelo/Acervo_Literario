...
public class AddViewController implements Initializable {
    ...
    @FXML
    private TableColumn<Field, Button> FieldEdit_Col;
    @FXML
    private TableColumn<Field, Button> FieldDelete_Col;
    @FXML
    private TextField Title_TextFiled;
    @FXML
    private TextField Author_TextFiled;
    @FXML
    private TextField Publisher_TextFiled;
    @FXML
    private TextField Description_TextFiled;
    @FXML
    private TextField Location_TextFiled;
    @FXML
    private ComboBox<Field> Field_ComboBox;
    @FXML
    ...
    @FXML
    private TableColumn<Book, Button> BookEdit_Col;
    @FXML
    private TableColumn<Book, Button> BookDelete_Col;
    @FXML
    private TextField searchFieldBox;
    @FXML
    private TextField SearchBookBox;
    @FXML
