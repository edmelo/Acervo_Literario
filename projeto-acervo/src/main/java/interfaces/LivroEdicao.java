...
public class LivroEdicao extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LivroEdicao frame = new LivroEdicao();
	...
	/**
	 * Helper method to get the file path without extension.
	 */
	...
	/**
	 * Method to set the values of the book details in the UI components.
	 */
	 ...
	 */
	public LivroEdicao() throws ExcecaoControlador {
		// Set the frame to adjust to the user's screen size
